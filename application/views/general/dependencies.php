...
<link rel="stylesheet" href="<?php echo base_url() . 'assets/js/css/validationEngine.jquery.css'; ?>" type="text/css"/>
...
<script src="<?php echo base_url() . 'asset/js/jquery.validationEngine.js'; ?>" type="text/javascript" charset="utf-8"></script>
